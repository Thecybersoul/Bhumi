...
const routes = [
  ...
  {
    label: 'JDA and structuring',
    detail: 'Weighing a developer proposal? Send the terms and we will model the alternatives.',
    href: wa.jda,
    icon: 'structure' as const,
  },
  {
    label: 'Construction oversight',
    detail: 'Independent stage-gate verification, reporting to you rather than to the builder.',
    href: wa.construction,
    icon: 'crane' as const,
  },
  {
    label: 'Marketing and sales',
    detail: 'Campaigns reported on qualified leads and cost per lead, weekly.',
    href: wa.marketing,
