    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#fdfbf7' }}>
      ...
      <main style={{ flex: 1, padding: '80px 24px' }}>
        <div className="wrap" style={{ maxWidth: 800 }}>
          ...
          <h1 style={{ fontFamily: 'var(--serif)', fontSize: '2.5rem', marginBottom: 16, color: 'var(--ink)' }}>{terms.title}</h1>
          <p style={{ color: 'var(--ink-2)', lineHeight: 1.7, fontSize: '1.05rem', marginBottom: 32 }}>{terms.intro}</p>
