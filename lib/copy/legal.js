...
export const privacy = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'Your information is used to process your enquiries, connect you with the verified seller of the parcel you asked about, and provide tailored property recommendations. We may also use your contact details to send occasional updates on the Bengaluru land market, which you can opt out of at any time.',
    },
    {
      heading: '3. Data Sharing',
      body: 'We share your name, phone, and enquiry details only with the verified seller of the parcel you enquired about. We do not sell your personal data to advertisers or third-parties — ever.',
    },
    {
...
export const terms = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'Submitting an enquiry or scheduling a site visit through the platform does not create a binding contract. All transactions are subject to formal legal documentation, title verification at the sub-registrar, and offline execution. Bhūmī does not act as an agent or escrow.',
    },
    {
      heading: '4. Fees',
    ...
    },
    {
      ...
      body: 'Bhūmī is not liable for any loss arising from a transaction between a buyer and a seller introduced through the platform. We verify listings to the best of our ability but cannot warrant the future conduct of any party.',
    },
  ],
}
