...
export const hero = {
  eyebrow: 'Verified Land Marketplace · Bengaluru',
  title: { before: 'Stop searching land.', italic: 'Start selecting', after: ' it.' },
  subhead:
    "Bengaluru's only marketplace where every parcel is 9-point verified, title-cleared, and conversion-mapped. Direct to seller — no brokers, no WhatsApp groups, no surprises at registration.",
  primaryCta: { label: 'Chat with a land expert on WhatsApp', href: 'https://wa.me/918123845749?text=Hi%20Bh%C5%ABm%C4%AB%2C%20I%27d%20like%20to%20talk%20to%20a%20land%20expert.' },
